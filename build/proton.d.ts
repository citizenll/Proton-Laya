/// <reference path="../engine/types/LayaAir.d.ts" />

declare namespace ProtonEngine {
    type Mixed = any
    type Int = number
    class Stats {
    ...
    class Proton {
        ...
        static MathUtil: typeof MathUtil
        static Vector2D: typeof Vector2D
        static Polar2D: typeof Polar2D
        static ArraySpan: typeof ArraySpan
        ...
        static Mat3: Mat3
        static getSpan
        static createArraySpan
        static Initialize: typeof Initialize
        ...
        static Behaviour: typeof Behaviour
        static Force: typeof Force
        static Attraction: typeof Attraction
        static RandomDrift: typeof RandomDrift
        static Gravity: typeof Gravity
        static Collision: typeof Collision
        static CrossZone: typeof CrossZone
        static Alpha: typeof Alpha
        static Scale: typeof Scale
        static Rotate: typeof Rotate
        static Color: typeof Color
        static Repulsion: typeof Repulsion
        static Cyclone: typeof Cyclone
        static GravityWell: typeof GravityWell
        static Emitter: typeof Emitter
        static BehaviourEmitter: typeof BehaviourEmitter
        static FollowEmitter: typeof FollowEmitter
        static Zone: typeof Zone
        static LineZone: typeof LineZone
        static CircleZone: typeof CircleZone
        static PointZone: typeof PointZone
        static RectZone: typeof RectZone
        static ImageZone: typeof ImageZone
        static CanvasRenderer: typeof CanvasRenderer
        static DomRenderer: typeof DomRenderer
        static EaselRenderer: typeof EaselRenderer
        static PixiRenderer: typeof PixelRenderer
        static PixelRenderer: typeof PixelRenderer
        static WebGLRenderer: typeof WebGLRenderer
        static CustomRenderer: typeof CustomRenderer
        static LayaRenderer: typeof LayaRenderer
        static Debug: Debug
         ...
         *
         * @param {Number | undefined} [integrationType=EULER]
         *
         * @property {String} [integrationType=EULER]
         ...
         */
        addRenderer(render: BaseRenderer): void;
        /**
         ...
         * @param {Renderer} render
         */
        removeRenderer(render: BaseRenderer): void;
        /**
         * add the Emitter
         *
         * @method addEmitter
    ...
    class Vector2D {
         ...
         * @returns {Vector2D} This vector.
         */
        add(v: Vector2D, w?: Vector2D): Vector2D;
        /**
         ...
         * @returns {Vector2D} This vector.
         */
        addXY(a: number, b: number): Vector2D;
        /**
         ...
         * @returns {Vector2D} This vector.
         */
        addVectors(a: Vector2D, b: Vector2D): Vector2D;
        /**
         ...
         * @returns {Vector2D} This vector.
         */
        sub(v: Vector2D, w?: Vector2D): Vector2D;
        /**
         ...
         * @returns {Vector2D} This vector.
         */
        subVectors(a: Vector2D, b: Vector2D): Vector2D;
        /**
    ...
    class Util {
         ...
         */
        static initValue(value: Mixed, defaults: Mixed): Mixed;
         ...
         */
        static emptyArray(arr: any): void;

        static toArray(arr: any): any;
        static sliceArray(arr1: any, index: any, arr2: any): void;
        static getRandFromArray(arr: any): any;
         ...
         */
        static emptyObject(obj: Object, ignore?: null): void;
         ...
         */
        static classApply(constructor: Function, args?: any[]): Object;

        /**  
         * This will get the image data. It could be necessary to create a Zone.  
         *  
         * @param {HTMLCanvasElement}   context any canvas, must be a 2dContext 'canvas.getContext('2d')'  
         * @param {Object}              image   could be any dom image, e.g. document.getElementById('thisIsAnImgTag');  
         * @param {Rectangle}    rect  
         */
        static getImageData(context: HTMLCanvasElement, image: Object, rect: Rectangle): any;

        static destroyAll(arr: any, param?: null): void;
    ...
    class ColorUtil {
         ...
         * @return {RgbObject}  
         */
        static hexToRgb(h: string): RgbObject;

        /**  
         * converts a rgb value to a rgb string  
         *  
         * @param {Object | RgbObject} rgb a rgb object  
         *  
         * @return {String} rgb()  
         */
        static rgbToHex(rgb: any): string;

        static getHex16FromParticle(p: any): number;
    }
    ...
    class Mat3 {
         ...
         * @param mat3 Optional existing matrix to initialize from  
         * @returns New Float32Array representing a 3x3 matrix  
         */
        static create(mat3?: Float32Array): Float32Array;
         ...
         */
        static set(mat1: Float32Array, mat2: Float32Array): Float32Array;

        /**  
         * Multiplies two matrices  
         * @param mat First matrix  
         * @param mat2 Second matrix  
         * @param mat3 Optional target matrix  
         * @returns The resulting matrix  
         */
        static multiply(mat: Float32Array, mat2: Float32Array, mat3?: Float32Array): Float32Array;
         ...
         */
        static inverse(mat: Float32Array, mat3?: Float32Array): Float32Array;

        /**  
         * Multiplies a matrix by a 2D vector  
         * @param m The matrix  
         * @param vec The vector (as [x, y])  
         * @param mat3 Optional target matrix  
         * @returns The transformed vector  
         */
        static multiplyVec2(m: Float32Array, vec: [number, number], mat3?: Float32Array): [number, number];
    }
    ...
    class Ease {
        ...
        static easeInQuad(value: any): number;
        static easeOutQuad(value: any): number;
        static easeInOutQuad(value: any): number;
        static easeInCubic(value: any): number;
        static easeOutCubic(value: any): number;
        static easeInOutCubic(value: any): number;
        static easeInQuart(value: any): number;
        static easeOutQuart(value: any): number;
        static easeInOutQuart(value: any): number;
        static easeInSine(value: any): number;
        static easeOutSine(value: any): number;
        static easeInOutSine(value: any): number;
        static easeInExpo(value: any): number;
        static easeOutExpo(value: any): number;
        static easeInOutExpo(value: any): number;
        static easeInCirc(value: any): number;
        static easeOutCirc(value: any): number;
        static easeInOutCirc(value: any): number;
        static easeInBack(value: any): number;
        static easeOutBack(value: any): number;
        static easeInOutBack(value: any): number;
        static getEasing(ease: Ease): any;
    }
    ...
    class Behaviour {
         ...
         * @param {Vector2D} force - The force to normalize
         * @returns {Vector2D} The normalized force
         */
         ...
         * @param {Particle} particle - The particle to calculate for
         * @param {number} time - The integrate time 1/ms
         * @param {number} index - The particle index
         */
        calculate(particle: Particle, time: number, index: number): void;
        /**
    ...
    class Attraction extends Behaviour {
         ...
         */
        constructor(targetPosition: Vector2D, force?: number, radius?: number, life?: number, easing?: string);
        /**
         ...
         *///@ts-ignore
        reset(targetPosition: Vector2D, force?: number, radius?: number, life?: number, easing?: string): void;
    }
    ...
    class Collision extends Behaviour {
         ...
         *
         * @param {Emitter} 	[emitter=null] 		the attraction point coordinates
         ...
         * @property {String} name The Behaviour name
         */
        constructor(emitter?: Emitter, mass?: boolean, callback?: (particle: Particle, otherParticle: Particle) => Collision, life?: number, easing?: string);
        newPool: any[];
        pool: any[];
        /**
         * Reset this behaviour's parameters
         ...
         * @param {String} [easing=ease.easeLinear] 	this behaviour's easing
         *///@ts-ignore
        reset(emitter?: Emitter, mass?: boolean, callback?: (particle: Particle, otherParticle: Paritcle) => Collision, life?: number, easing?: string): void;
        emitter: any;
        mass: any;
        callback: any;
        collisionPool: any[] | undefined;
        delta: Vector2D | undefined;
        /**
         * Apply this behaviour for all particles every time
         *
         * @memberof Proton#Collision
    ...
    class CrossZone extends Behaviour {
         ...
         * @alias CrossZone
         *
         * @param {Zone} zone 						can be any Zone - e.g. RectZone()
    ...
    class Color extends Behaviour {
         ...
         * @alias Color
         *
         * @param {ArraySpan | String} [a] the string should be a hex e.g. #000000 for black
         * @param {ArraySpan | String} [b] the string should be a hex e.g. #000000 for black
         * @param {Number} [life=Infinity] 	this behaviour's life
         * @param {String} [easing=easeLinear] 	this behaviour's easing
         *
         * @property {String} name The Behaviour name
         */
        constructor(a?: ArraySpan | string, b?: ArraySpan | string, life?: number, easing?: string);
        /**
         * Reset this behaviour's parameters
         *
         * @method reset
         ...
         * @param {String} [easing=easeLinear] 	this behaviour's easing
         *///@ts-ignore
        reset(a: ArraySpan | string, b: ArraySpan | string, life?: number, easing?: string): void;
    ...
    class Repulsion {
         ...
         *
         * @constructor
         * @param {Vector2D} targetPosition - The repulsion point coordinates
         ...
         * Reset this behaviour's parameters
         *
         * @param {Vector2D} targetPosition - The new repulsion point coordinates
    ...
    class GravityWell extends Behaviour {
         ...
         * @property {String} name The Behaviour name
         */
        constructor(centerPoint?: Vector2D, force?: number, life?: number, easing?: string);
         ...
         * @param {String} [easing=easeLinear]	this behaviour's easing
         *///@ts-ignore
        reset(centerPoint?: Vector2D, force?: number, life?: number, easing?: string): void;
        /**
         * @inheritdoc
         */
        initialize(particle: any): void;
    ...
    class Emitter extends Particle {
         ...
         *
         */
        createParticle(initialize?: Object | any[], behaviour?: Object | any[]): Particle;
        /**
         ...
         * @param {Object|Array} [behaviour] - Behavior object or array of behavior objects.
         */
        setupParticle(particle: Particle, initialize?: Object | any[], behaviour?: Object | any[]): void;
        /**
    ...
    class BehaviourEmitter extends Emitter {
        /**
         * The BehaviourEmitter class inherits from Emitter
         *
     ...
     * @extends BaseRenderer
     */
    class LayaRenderer extends BaseRenderer {
        /**
    ...
    class LineZone extends Zone {
         ...
         */
        getSymmetric(v: Vector2D): Vector2D;
        /**
    ...
    class MathUtil {
        ...
        /** PI multiplied by 2 */
        static readonly PIx2: number;

        /** PI divided by 2 */
        static readonly PI_2: number;

        /** PI divided by 180 (conversion factor from degrees to radians) */
        static readonly PI_180: number;

        /** 180 divided by PI (conversion factor from radians to degrees) */
        static readonly N180_PI: number;
         ...
         */
        static isInfinity(num: any): boolean;

        /**  
         * Generates a random number between a and b  
         * @param a Lower bound  
         * @param b Upper bound  
         * @param isInt Whether to return an integer  
         * @returns Random number between a and b  
         */
        static randomAToB(a: any, b: any, isInt?: boolean): any;

        /**  
         * Generates a random floating point number around a center value  
         * @param center The center value  
         * @param f The floating range  
         * @param isInt Whether to return an integer  
         * @returns Random number around center ±f  
         */
        static randomFloating(center: any, f: any, isInt: any): any;

        /**  
         * Generates a random color in hex format  
         * @returns Random color string in format "#RRGGBB"  
         */
        static randomColor(): string;

        /**  
         * Generates a random zone within a display  
         * @param display The display boundary  
         */
        static randomZone(display: any): void;

        /**  
         * Floors a number to specified precision  
         * @param num The number to floor  
         * @param k The number of decimal places (default: 0)  
         * @returns The floored number  
         */
        static floor(num: any, k?: number): number;

        /**  
         * Converts angle units (degrees/radians)  
         * @param a The angle to convert  
         * @returns Converted angle  
         */
        static degreeTransform(a: any): number;

        /**  
         * Converts a number to hexadecimal color string  
         * @param num The number to convert  
         * @returns Color string in format "#RRGGBB"  
         */
        static toColor16(num: any): string;
    }

    class Debug {
        /**  
         * Adds a debug event listener to a Proton instance  
         * @param proton The Proton instance to debug  
         * @param func Callback function for debug events  
         */
        static addEventListener(proton: ProtonEngine.Proton, func: (event: any) => void): void;

        /**  
         * Gets a CSS style string for debug rendering  
         * @param color Optional color for the debug elements  
         * @returns CSS style string  
         */
        static getStyle(color?: string): string;

        /**  
         * Draws a zone for debugging purposes  
         * @param proton The Proton instance  
         * @param canvas The canvas to draw on  
         * @param zone The zone to visualize  
         * @param clear Whether to clear the canvas before drawing  
         */
        static drawZone(proton: ProtonEngine.Proton, canvas: HTMLCanvasElement, zone: ProtonEngine.Zone, clear: boolean): void;

        /**  
         * Draws an emitter for debugging purposes  
         * @param proton The Proton instance  
         * @param canvas The canvas to draw on  
         * @param emitter The emitter to visualize  
         * @param clear Whether to clear the canvas before drawing  
         */
        static drawEmitter(proton: ProtonEngine.Proton, canvas: HTMLCanvasElement, emitter: ProtonEngine.Emitter, clear: boolean): void;
    }
}


import proton = ProtonEngine.Proton;
import Proton = ProtonEngine;