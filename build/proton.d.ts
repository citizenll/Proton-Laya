...
declare namespace _default$2 {
     ...
     */
    function hexToRgba(h: string): Object;
    /**
...
declare class Gradient extends Behaviour$1 {
    /**
     * 渐变颜色行为
     * @constructor
     ...
     */
    constructor(colors: any[], life?: number, easing?: string);
    colors: any[];
    reset(colors: any, life: any, easing: any): void;
    initialize(particle: any): void;
...
export { Alpha, ArraySpan, Attraction, Behaviour$1 as Behaviour, BehaviourEmitter, Body, CanvasRenderer, CircleZone, Collision, Color, _default$2 as ColorUtil, CrossZone, CustomRenderer, Cyclone, _default as Debug, DomRenderer, EaselRenderer, Emitter$1 as Emitter, FollowEmitter, Force, Gradient, Gravity, GravityWell, ImageZone, Initialize, LayaRenderer, Life, LineZone, Mass, Mat3, MathUtil, Particle$1 as Particle, PixelRenderer, PixiRenderer, PointZone, Polar2D, Pool, Position, Radius, RandomDrift, Rate, RectZone, Rectangle, Repulsion, Rotate, Scale, Span, _default$3 as Util, Vector2D$1 as Vector2D, Velocity, WebGLRenderer, Zone, Proton$1 as default, _default$1 as ease };
